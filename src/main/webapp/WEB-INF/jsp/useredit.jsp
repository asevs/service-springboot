...
<head>
    ...
    <title><s:message code="menu.editPage"/></title>
</head>
<body>
<%@include file="menu.app" %>
<h2><s:message code="menu.editPage"/></h2>

<p align="center">
    <c:out value="${message}" />
</p>
<sf:form id="usersForm" action="${pageContext.request.contextPath}/updateuser/${user.id}" modelAttribute="user"
    ...
    <table width="500" border="0" cellpadding="4" cellspacing="1"
        ...
        <tr>
            <td width="130" align="right" ><s:message code="profil.role"/></td>
